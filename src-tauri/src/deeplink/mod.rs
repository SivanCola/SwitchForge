//! Deep link import functionality for SwitchForge
//!
//! This module implements the switchforge:// protocol for importing configurations
...
///
/// Represents a parsed switchforge:// URL ready for processing.
