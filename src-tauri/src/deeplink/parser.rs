...
//!
//! Parses switchforge:// URLs into DeepLinkImportRequest structures.
...
/// Parse a switchforge:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// switchforge://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "switchforge" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'switchforge', got '{scheme}'"
        )));
    }
