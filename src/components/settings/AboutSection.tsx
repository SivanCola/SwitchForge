    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/SivanCola/SwitchForge/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/SivanCola/SwitchForge/releases/tag/${displayVersion}`,
      );
    } catch (error) {
          ...
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="SwitchForge" className="h-5 w-5" />
            ...
            <Button
              ...
              onClick={() =>
                settingsApi.openExternal(
                  "https://github.com/SivanCola/SwitchForge",
                )
              }
